...
$string['enableidnumberpadding'] = 'Padding zeros for idnumber field';
$string['enableidnumberpadding_desc'] = 'Use same value on remote and local site! If Enabled and chosen idnumber as matching user attribute, idnumber field will be padded to 9 digits by zeros.';
...
$string['remote_backup_provider:access'] = 'Import from remote';
$string['foundcourses'] = 'Available source courses';
$string['notfoundcourses'] = 'No available source courses';
$string['sourcemoodle'] = 'Source:';
$string['nomatchuser'] = 'User not found in source Moodle';
